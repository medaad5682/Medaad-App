        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(AppLocalizations.of(context)!
                  .errorLoadingDataWithDetails(e.toString())),
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(AppLocalizations.of(context)!
                  .failedToFetchDataWithDetails(e.toString())),
              backgroundColor: AppColors.error),
        );
      }
    }
  ...
  Future<void> _handleDecision(String requestId, bool approve) async {
      ...
      rejectionReason = await showDialog<String>(
        ...
        builder: (ctx) {
          ...
          return AlertDialog(
            ...
            title: Text(
                AppLocalizations.of(context)!.rejectionReasonDialogTitle,
                style: TextStyle(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                child: Text(
                    AppLocalizations.of(context)!.confirmRejectionAction,
    ...
    try {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content:
                Text(AppLocalizations.of(context)!.processingActionMessage),
              ...
              children: [
                ...
                Text(approve
                    ? AppLocalizations.of(context)!
                        .studentApprovedSuccessMessage
                    : AppLocalizations.of(context)!.requestRejectedMessage),
              ],
            ),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(AppLocalizations.of(context)!
                  .operationFailedWithDetails(e.toString())),
              backgroundColor: AppColors.error),
        );
      }
    }
                  ...
                  errorWidget: (context, url, error) => Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            AppLocalizations.of(context)!
                                .imageLoadFailedCheckConnection,
                            style: TextStyle(color: AppColors.textSecondary)),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        ...
                        if (hasDiscount)
                          Text(
                              AppLocalizations.of(context)!
                                  .priceEgp(originalPrice.toString()),
                              style: TextStyle(
                                  color: AppColors.textSecondary,
                                  fontSize: 12,
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: Text(
                          AppLocalizations.of(context)!.rejectRequestAction,
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      icon: const Icon(Icons.check_circle_outline_rounded,
                          size: 20),
                      label: Text(
                          AppLocalizations.of(context)!.acceptAndActivateAction,
                          style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                  ),
                ],
