        ...
        if (e is DioException) {
          if (e.response?.statusCode == 403)
            msg = e.response?.data['error'] ??
                AppLocalizations.of(context)!.accessDeniedFallback;
  ...
  Future<void> _showExitWarningDialog() async {
    final shouldSubmit = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(AppLocalizations.of(context)!.exitExamWarningMessage,
            style: TextStyle(color: AppColors.textSecondary)),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx, false),
            child: Text(AppLocalizations.of(context)!.stayButton,
                style: TextStyle(color: AppColors.textSecondary)),
          ),
          ElevatedButton(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: AppColors.accentYellow.withOpacity(0.3)),
            ),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: BorderSide(color: AppColors.accentYellow, width: 1.5),
            ),
          ),
          onChanged: (val) {
        ...
        Align(
          ...
          child: Text(
            AppLocalizations.of(context)!
                .charactersCountLabel(ctrl.text.trim().length),
            style: TextStyle(
                  ...
                  children: [
                    if (!_isModelAnswerMode)
                      IconButton(
                        ...
                        tooltip:
                            AppLocalizations.of(context)!.markQuestionTooltip,
                      ),
                    Text(
                        AppLocalizations.of(context)!.questionCounterLabel(
                            currentIdx + 1, _questions.length),
                        style: TextStyle(
                    ...
                    if (!_isModelAnswerMode)
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20)),
                        child: Text(
                            AppLocalizations.of(context)!.modelAnswerLabel,
                            style: TextStyle(
                                color: AppColors.accentYellow,
                                fontSize: 10,
                                fontWeight: FontWeight.bold)),
                    ...
                    children: [
                      ...
                      Text(
                        questionData['question_text'] ??
                            AppLocalizations.of(context)!.questionTextFallback,
                        style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: AppColors.textPrimary,
