...
class _NativeVideoPlayerScreenState extends State<NativeVideoPlayerScreen>
  ...
  /// يلتقط الإطار الحالي للفيديو + العلامة المائية، ثم يشفّره فوراً
  /// ويحفظه — لا تُكتب أي بايتات صورة غير مشفّرة على القرص في أي لحظة
  /// (راجع VideoScreenshotService.saveEncrypted).
  ///
