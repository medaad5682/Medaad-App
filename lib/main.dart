...
void main() async {
  runZonedGuarded<Future<void>>(() async {
    // ✅ [CRASH-FIX v2.1.2] تمت إزالة حزمة google_fonts بالكامل (كانت سبب
    // انهيارات "font Roboto-* was not found in the application assets" و
    // "Failed to load font with url"). راجع app_theme.dart.
